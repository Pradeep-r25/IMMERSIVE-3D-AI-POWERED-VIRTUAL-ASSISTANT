...
const voiceID = "e8nb9LFWnZcesNXfxBiC";
    ...
    messages: [
      {
        role: "system",
        content: `
        Today's date and time in IST is ${new Date().toLocaleString("en-IN", { timeZone: "Asia/Kolkata", hour12: true })}.
        You are a 3D Ai Assistant.
